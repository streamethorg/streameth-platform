  ...
  try {
    ...
    return (
      <ScheduleContextProvider event={event.toJson()} stages={stages} days={dates}>
        <div className="w-full mx-auto max-w-7xl h-full relative md:overflow-scroll">
          <div className="text-center sticky top-0 z-10 flex flex-row flex-wrap md:flex-col bg-base justify-center">
