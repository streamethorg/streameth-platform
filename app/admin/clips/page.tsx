...
export default async function Page() {
  const res = await fetch(`https://livepeer.studio/api/asset?filters=[{"id":"sourceType","value":"clip"}]`, {
    method: 'GET',
    headers: {
