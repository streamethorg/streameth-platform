...
const models: TsoaRoute.Models = {
    ...
    "ISession": {
        ...
        "properties": {
            ...
            "transcripts": {"dataType":"nestedObjectLiteral","nestedProperties":{"text":{"dataType":"string","required":true},"chunks":{"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"word":{"dataType":"string","required":true},"end":{"dataType":"double","required":true},"start":{"dataType":"double","required":true}}},"required":true},"subtitleUrl":{"dataType":"string","required":true},"status":{"ref":"TranscriptionStatus","required":true}}},
    ...
    "Omit_IMarker.talkType_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IMarker.Exclude_keyofIMarker.talkType__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UpdateMarkerDto": {
        "dataType": "refObject",
        "properties": {
            "organizationId": {"dataType":"string","required":true},
            "markers": {"dataType":"array","array":{"dataType":"refAlias","ref":"Omit_IMarker.talkType_"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "RemotionPayload": {
        ...
        "properties": {
            ...
            "outputUrl": {"dataType":"string"},
            "lambdaErrors": {"dataType":"array","array":{"dataType":"string"}},
            "outputFile": {"dataType":"string"},
            "timeToFinish": {"dataType":"double"},
            "costs": {"dataType":"nestedObjectLiteral","nestedProperties":{"estimatedDisplayCost":{"dataType":"string","required":true},"estimatedCost":{"dataType":"double","required":true},"disclaimer":{"dataType":"string","required":true},"currency":{"dataType":"string","required":true}}},
            "errors": {"dataType":"array","array":{"dataType":"nestedObjectLiteral","nestedProperties":{"stack":{"dataType":"string","required":true},"name":{"dataType":"string","required":true},"message":{"dataType":"string","required":true}}}},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router,opts?:{multer?:ReturnType<typeof multer>}) {
    ...
    const upload = opts?.multer ||  multer({"limits":{"fileSize":8388608}});
        ...
        app.post('/sessions/import',
            authenticateMiddleware([{"jwt":["org"]}]),
            ...(fetchMiddlewares<RequestHandler>(SessionController)),
            ...(fetchMiddlewares<RequestHandler>(SessionController.prototype.importVideoFromUrl)),

            async function SessionController_importVideoFromUrl(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"organizationId":{"dataType":"string","required":true},"url":{"dataType":"string","required":true},"name":{"dataType":"string","required":true}}},
            };
        ...
        app.post('/sessions/:sessionId/highlights',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    sessionId: {"in":"path","name":"sessionId","required":true,"dataType":"string"},
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"prompt":{"dataType":"string"}}},
            };
