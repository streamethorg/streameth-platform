...
const models: TsoaRoute.Models = {
  ...
  IOrganization: {
    ...
    properties: {
      ...
      socials: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISocials' },
      },
    },
    additionalProperties: false,
  },
  ...
  'IStandardResponse_ISupport-Array_': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISupport' },
      },
    },
    additionalProperties: false,
  },
  ...
  'IStandardResponse__playbackUrl-string--phaseStatus-string__': {
    ...
    properties: {
      ...
      data: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {
          phaseStatus: { dataType: 'string', required: true },
          playbackUrl: { dataType: 'string', required: true },
        },
      },
    },
    additionalProperties: false,
  ...
  'IStandardResponse__viewCount-number--playTimeMins-number__': {
    ...
    properties: {
      ...
      data: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {
          playTimeMins: { dataType: 'double', required: true },
  ...
  CreateClipDto: {
    ...
    properties: {
      ...
      editorOptions: {
        dataType: 'nestedObjectLiteral',
        nestedProperties: {
          captionColor: { dataType: 'string', required: true },
          captionFont: { dataType: 'string', required: true },
          captionLinesPerPage: { dataType: 'double', required: true },
          captionPosition: { dataType: 'string', required: true },
          captionEnabled: { dataType: 'boolean', required: true },
          selectedAspectRatio: { dataType: 'string', required: true },
          events: {
            dataType: 'array',
            array: {
              dataType: 'nestedObjectLiteral',
          ...
          frameRate: { dataType: 'double', required: true },
        },
      },
    },
    additionalProperties: false,
  ...
  StateType: {
    dataType: 'refEnum',
    enums: ['nft', 'event', 'video', 'transcrpition', 'social', 'animation'],
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  IState: {
    dataType: 'refObject',
  ...
  IStage: {
    ...
    properties: {
      ...
      source: {
        ...
        nestedProperties: {
          type: { dataType: 'string', required: true },
          m3u8Url: { dataType: 'string', required: true },
          url: { dataType: 'string', required: true },
        },
      },
    },
  ...
  SessionType: {
    dataType: 'refEnum',
    enums: ['clip', 'livestream', 'video', 'animation', 'editorClip'],
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ProcessingStatus: {
    dataType: 'refEnum',
  ...
  IStandardResponse_Array_IUser__: {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IUser' },
      },
    },
    additionalProperties: false,
  },
    ...
    properties: {
      ...
      videos: {
        ...
        array: {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            ipfsURI: { dataType: 'string', required: true },
            stageId: { dataType: 'string' },
            sessionId: { dataType: 'string' },
            type: { dataType: 'string', required: true },
  ...
  IStandardResponse_Array_INftCollection__: {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'INftCollection' },
      },
    },
    additionalProperties: false,
  },
  ...
  'IStandardResponse_IMarker-Array_': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IMarker' },
      },
    },
    additionalProperties: false,
  },
  ...
  'IStandardResponse_IChat-Array_': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IChat' },
      },
    },
    additionalProperties: false,
  },
...
export function RegisterRoutes(
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      SupportController.prototype.createTicket,
    ),

    async function SupportController_createTicket(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(SupportController),
    ...fetchMiddlewares<RequestHandler>(
      SupportController.prototype.getAllTickets,
    ),

    async function SupportController_getAllTickets(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.createMultiStream,
    ),

    async function StreamController_createMultiStream(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.deleteMultiStream,
    ),

    async function StreamController_deleteMultiStream(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function StreamController_createAsset(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StreamController_getStream(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StreamController_getAsset(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StreamController_getVideoUrl(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.getPhaseAction,
    ),

    async function StreamController_getPhaseAction(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.getSessionMetrics,
    ),

    async function StreamController_getSessionMetrics(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.getStreamRecordings,
    ),

    async function StreamController_getStreamRecordings(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.uploadToIpfs,
    ),

    async function StreamController_uploadToIpfs(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function StreamController_createClip(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(StreamController),
    ...fetchMiddlewares<RequestHandler>(
      StreamController.prototype.generateThumbnail,
    ),

    async function StreamController_generateThumbnail(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function StreamController_getHls(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function StateController_createState(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function StateController_updateState(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StateController_getAllStates(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function StageController_createStage(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(StageController),
    ...fetchMiddlewares<RequestHandler>(
      StageController.prototype.createHlsStage,
    ),

    async function StageController_createHlsStage(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function StageController_editStage(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StageController_getStageById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StageController_getAllStages(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function StageController_getAllStagesForEvent(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(StageController),
    ...fetchMiddlewares<RequestHandler>(
      StageController.prototype.getAllStagesForOrganization,
    ),

    async function StageController_getAllStagesForOrganization(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    async function StageController_deleteStage(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function SpeakerController_createSpeaker(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function SpeakerController_getSpeaker(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function SpeakerController_getAllSpeakersForEvent(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function SessionController_editSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(SessionController),
    ...fetchMiddlewares<RequestHandler>(
      SessionController.prototype.getOrgEventSessions,
    ),

    async function SessionController_getOrgEventSessions(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(SessionController),
    ...fetchMiddlewares<RequestHandler>(
      SessionController.prototype.filterSession,
    ),

    async function SessionController_filterSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(SessionController),
    ...fetchMiddlewares<RequestHandler>(
      SessionController.prototype.filterSessionByOrganisation,
    ),

    async function SessionController_filterSessionByOrganisation(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function SessionController_getSessionById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(SessionController),
    ...fetchMiddlewares<RequestHandler>(
      SessionController.prototype.sessionTranscriptions,
    ),

    async function SessionController_sessionTranscriptions(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        body: {
          ...
          name: 'body',
          required: true,
          ref: 'Pick_UploadSessionDto.organizationId-or-sessionId_',
        },
      };
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(SessionController),
    ...fetchMiddlewares<RequestHandler>(
      SessionController.prototype.uploadSessionToSocials,
    ),

    async function SessionController_uploadSessionToSocials(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function SessionController_getAllSessions(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    async function SessionController_deleteSession(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      ScheduleImporterController.prototype.importSchdeule,
    ),

    async function ScheduleImporterController_importSchdeule(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        body: {
          ...
          name: 'body',
          required: true,
          ref: 'Pick_IScheduleImporterDto.url-or-type-or-organizationId_',
        },
      };
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(ScheduleImporterController),
    ...fetchMiddlewares<RequestHandler>(
      ScheduleImporterController.prototype.importSchdeuleByStage,
    ),

    async function ScheduleImporterController_importSchdeuleByStage(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        body: {
          ...
          name: 'body',
          required: true,
          ref: 'Pick_IScheduleImporterDto.url-or-type-or-organizationId-or-stageId_',
        },
      };
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(ScheduleImporterController),
    ...fetchMiddlewares<RequestHandler>(
      ScheduleImporterController.prototype.save,
    ),

    async function ScheduleImporterController_save(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        body: {
          ...
          nestedProperties: {
            organizationId: { dataType: 'string', required: true },
            scheduleId: { dataType: 'string', required: true },
          },
        },
      };
  ...
  app.put(
    ...
    async function OrganizationController_editOrganization(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(OrganizationController),
    ...fetchMiddlewares<RequestHandler>(
      OrganizationController.prototype.updateOrgMembers,
    ),

    async function OrganizationController_updateOrgMembers(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        body: {
          ...
          name: 'body',
          required: true,
          ref: 'Pick_CreateOrganizationDto.address_',
        },
      };
  ...
  app.get(
    ...
    async function OrganizationController_getOrganizationById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function OrganizationController_getAllOrganizations(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(OrganizationController),
    ...fetchMiddlewares<RequestHandler>(
      OrganizationController.prototype.getAllOrgMembers,
    ),

    async function OrganizationController_getAllOrgMembers(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(OrganizationController),
    ...fetchMiddlewares<RequestHandler>(
      OrganizationController.prototype.deleteOrgMember,
    ),

    async function OrganizationController_deleteOrgMember(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(OrganizationController),
    ...fetchMiddlewares<RequestHandler>(
      OrganizationController.prototype.updateOrgSocials,
    ),
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(OrganizationController),
    ...fetchMiddlewares<RequestHandler>(
      OrganizationController.prototype.deleteOrgSocial,
    ),

    async function OrganizationController_deleteOrgSocial(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        body: {
          ...
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            destinationId: { dataType: 'string', required: true },
          },
        },
      };
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.createNftCollection,
    ),

    async function NftCollectionRouter_createNftCollection(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(NftCollectionRouter),
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.generateNftMetadata,
    ),

    async function NftCollectionRouter_generateNftMetadata(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(NftCollectionRouter),
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.updateNftCollection,
    ),

    async function NftCollectionRouter_updateNftCollection(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(NftCollectionRouter),
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.getAllCollections,
    ),

    async function NftCollectionRouter_getAllCollections(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(NftCollectionRouter),
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.getNftCollectionById,
    ),

    async function NftCollectionRouter_getNftCollectionById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(NftCollectionRouter),
    ...fetchMiddlewares<RequestHandler>(
      NftCollectionRouter.prototype.getAllOrganizationNft,
    ),

    async function NftCollectionRouter_getAllOrganizationNft(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.createMarker,
    ),

    async function MarkerController_createMarker(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(MarkerController),
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.updateMarkers,
    ),

    async function MarkerController_updateMarkers(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(MarkerController),
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.updateMarker,
    ),

    async function MarkerController_updateMarker(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(MarkerController),
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.importMarkers,
    ),

    async function MarkerController_importMarkers(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(MarkerController),
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.getAllMarkers,
    ),

    async function MarkerController_getAllMarkers(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(MarkerController),
    ...fetchMiddlewares<RequestHandler>(
      MarkerController.prototype.deleteMarker,
    ),

    async function MarkerController_deleteMarker(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function IndexController_index(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function IndexController_uploadImges(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function IndexController_webhook(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function EventController_getEventById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function EventController_editEvent(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.put(
    ...
    async function EventController_evenImporter(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function EventController_getAllEvents(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function ChatController_createCHar(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(ChatController),
    ...fetchMiddlewares<RequestHandler>(
      ChatController.prototype.getChatStageById,
    ),

    async function ChatController_getChatStageById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function AuthController_verifyToken(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(AuthController),
    ...fetchMiddlewares<RequestHandler>(
      AuthController.prototype.getTokenPayload,
    ),

    async function AuthController_getTokenPayload(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.post(
    ...
    async function AuthController_sendMagicLink(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
