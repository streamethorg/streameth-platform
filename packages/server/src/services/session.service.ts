...
export default class SessionService {
  ...
  async createMetadata(sessionId: string) {
    ...
    let metadata = {
      ...
      animation_url: `<iframe src="${config.baseUrl}/embed/?playbackId=${session.playbackId}&vod=true&streamId=&playerName=${session.name} width="100%" height="100%" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>`,
