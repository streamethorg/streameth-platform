  ...
  return (
    <aside className="flex h-screen flex-col border-r bg-white">
      ...
      <Link
        ...
        {!expanded && (
          <div
            className={`invisible absolute left-full ml-2 -translate-x-3 rounded-md bg-primary px-2 py-1 text-sm opacity-20 transition-all group-hover:visible group-hover:translate-x-0 group-hover:opacity-100`}>
            Docs
          </div>
        )}
      </Link>
...
export const SidebarItem = ({
  ...
  return (
    <li
      ...
      {!expanded && (
        <div
          className={`invisible absolute left-full z-50 ml-4 -translate-x-3 rounded-md bg-primary px-2 py-1 text-sm text-white opacity-20 transition-all group-hover:visible group-hover:translate-x-0 group-hover:opacity-100`}>
          {text}
        </div>
      )}
    </li>
