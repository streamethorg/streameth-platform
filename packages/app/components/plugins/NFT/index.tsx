  ...
  return (
    <div className="flex flex-col justify-center">
      <div className="w-full p-2">
        <p className=" ">
          By minting the Base Miami Broadcast NFT, you can experience Base House
          and tune in to the programming LIVE from any NFT marketplace.
          <br />
          <br />
          With the Base Miami Broadcast NFT, you will also be eligible for
          commemorative drops after the event.
        </p>
      </div>
