...
//    return (
//      <div className="flex flex-1 w-full h-full min-h-[400px]">
...
//    >
//      <div className="flex flex-1 h-full min-h-[400px]">
//        <Card className="sticky w-full h-full bg-opacity-30 border-l md:block">
//          <div className="flex absolute top-0 right-0 bottom-0 flex-col gap-2 p-2 w-full h-full">
//            {
//              <Chat
...
//  return (
//    <>
//      <div className="flex overflow-y-auto flex-col-reverse flex-1 min-h-0">
//        <Card className="flex absolute top-0 right-0 left-0 flex-row justify-center items-center p-2 m-1 space-x-2">
...
//          <Textarea
//            value={message}
//            className="border-box w-full h-1 min-h-[50px] dark:bg-zinc-900"
//            onChange={(e) => {
