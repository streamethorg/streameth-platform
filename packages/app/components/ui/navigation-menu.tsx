...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-10 w-full  lg:w-max lg:items-center lg:justify-center border-b border-1 border-accent lg:rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:border focus:border-background focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50'
)
