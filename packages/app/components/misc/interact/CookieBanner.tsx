...
const CookieBanner = () => {
  ...
  return (
    <Alert
      className={`duration-800 w-full transition-opacity lg:w-[35%] ${
        isFadingIn ? 'opacity-0' : 'opacity-100'
      } ${shouldFadeOut ? 'opacity-0' : ''}`}
    >
      <AlertTitle>We Use Cookies 🍪</AlertTitle>
      <AlertDescription>
        Your privacy is paramount to us. As a &quot;Privacy by Default&quot;
        platform, we only save essential cookies to enhance your experience
