  ...
  return (
    <CardContent className="space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Please click the button below to email support@streameth.org
        with your request:
      </p>
      ...
      <p className="text-sm text-gray-600">
        We will send an email confirmation that we received your
        request. We will then follow up with a zip file containing all
        your personal data saved on StreamETH.
      </p>
