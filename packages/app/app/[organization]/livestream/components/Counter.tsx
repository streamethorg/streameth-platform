...
const Counter = ({
  ...
  return (
    <div className="m-2 md:m-4 hidden sm:flex flex-col justify-between items-center md:p-0 backdrop-blur-sm backdrop-brightness-50 md:backdrop-brightness-100">
