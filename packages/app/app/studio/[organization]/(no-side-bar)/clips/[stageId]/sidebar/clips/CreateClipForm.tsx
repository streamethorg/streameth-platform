								...
								render={({ field }) => (
									<FormItem>
										...
										{field.value && showColorPicker && (
											<div
												ref={colorPickerRef}
												className="absolute z-10 p-4 mt-2 bg-white rounded-lg border border-gray-200 shadow-lg"
											>
												<Label className="mb-2 text-sm">Text Color</Label>
					...
					<div className="flex gap-2 w-full">
						...
						>
							{isCreateClip ? (
								...
								<>
									<LuScissorsLineDashed className="mr-2 w-4 h-4" />
									Create
								</>
							)}
						</Button>
