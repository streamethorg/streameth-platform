...
var setupWallet = defineWalletSetup(PASSWORD, function() {
    var _ref = _async_to_generator(function(context, walletPage) {
        var metamask;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    metamask = new MetaMask(context, walletPage, PASSWORD);
                    return [
                        4,
...
var basic_setup_default = setupWallet;
export { basic_setup_default as default };
