...
const run = async () => {
  ...
  const Event = {
    name: 'Zuzalu 2023 - Synthetic Biology',
    description: 'Zuzalu is a first-of-its-kind pop-up city community in Montenegro.',
    start: new Date('2023-04-01T00:00:00.000Z'), // "2021-09-30T00:00:00.000Z
    end: new Date('2023-04-02T00:00:00.000Z'), // "2021-10-02T00:00:00.000Z
    location: 'Montenegro',
